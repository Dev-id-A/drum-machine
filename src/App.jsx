      ...
      <div className="col-12 col-md-6 justify-content-between" id="pads">
        ...
        <div className="row justify-content-around">
          ...
          onClick={() => playAudio("Q")}>Q
            <audio className="clip" ref={(ref) => audioRefs.current[0] = ref} src="./sounds/Heater-1.mp3" id="Q"></audio>
          </button>
          <button className={`drum-pad col-3 btn btn-light ${clickedBtn==="W" ? "no-shadow-box":"shadow-box"}`} id="Heater-2" 
          onClick={() => playAudio("W")}>W
            <audio className="clip" ref={(ref) => audioRefs.current[1] = ref} src="./sounds/Heater-2.mp3" id="W"></audio>
          </button>
          <button className={`drum-pad col-3 btn btn-light ${clickedBtn==="E" ? "no-shadow-box":"shadow-box"}`} id="Heater-3" 
          onClick={() => playAudio("E")}>E
            <audio className="clip" ref={(ref) => audioRefs.current[2] = ref} src="./sounds/Heater-3.mp3" id="E"></audio>
          </button>
        </div>
        ...
        <div className="row justify-content-around">
          ...
          onClick={() => playAudio("A")}>A
            <audio className="clip" ref={(ref) => audioRefs.current[3] = ref} src="./sounds/Heater-4.mp3" id="A"></audio> 
          </button>
          <button className={`drum-pad col-3 btn btn-light ${clickedBtn==="S" ? "no-shadow-box":"shadow-box"}`} id="Clap" 
          onClick={() => playAudio("S")}>S
            <audio className="clip" ref={(ref) => audioRefs.current[4] = ref} src="./sounds/Clap.mp3" id="S"></audio>
          </button>
          <button className={`drum-pad col-3 btn btn-light ${clickedBtn==="D" ? "no-shadow-box":"shadow-box"}`} id="Open-HH" 
          onClick={() => playAudio("D")}>D
            <audio className="clip" ref={(ref) => audioRefs.current[5] = ref} src="./sounds/Open-HH.mp3" id="D"></audio>
          </button>
        </div>
        ...
        <div className="row justify-content-around">
          ...
          onClick={() => playAudio("Z")}>Z
            <audio className="clip" ref={(ref) => audioRefs.current[6] = ref} src="./sounds/Kick_n_Hat.mp3" id="Z"></audio>
          </button>
          <button className={`drum-pad col-3 btn btn-light ${clickedBtn==="X" ? "no-shadow-box":"shadow-box"}`} id="Kick" 
          onClick={() => playAudio("X")}>X
            <audio className="clip" ref={(ref) => audioRefs.current[7] = ref} src="./sounds/Kick.mp3" id="X"></audio>
          </button>
          <button className={`drum-pad col-3 btn btn-light ${clickedBtn==="C" ? "no-shadow-box":"shadow-box"}`} id="Closed-HH" 
          onClick={() => playAudio("C")}>C
            <audio className="clip" ref={(ref) => audioRefs.current[8] = ref} src="./sounds/Closed-HH.mp3" id="C"></audio>
          </button>
        </div>
